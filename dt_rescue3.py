# dt_rescue3.py  — improved DT shadow controller
import math
import numpy as np
...
class DTRescueController:
    ...
    def step(self, t, attack_flag, main_pose, main_control):
        ...
        # ===== DT =====
            ...
            # adapt depth during DT
            self.d_hat = update_depth_estimate(self.d_hat, e_x, e_y, e_th, float(u_ff[0]),
            ...
            if self.dt_state == 'TURN' or c_t < self.tau_turn:
                ...
                v_cmd, w_cmd = self._shadow_project(v_ref, w_ref, c_t, e_th, kappa_max,
                                                    main_pose, s_use, x_d)
